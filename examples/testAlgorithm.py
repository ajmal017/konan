...
class deltix(algorithm.DecisionAlgorithm):
        
#    def __init__(self, IBdb, IBeb):
#        
...
if (create):
    ...
    for _date in pd.date_range( datetime.date(2017,1,19), datetime.date(2017,3,2) ):
